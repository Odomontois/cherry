...
import cherry.lamr.norm.umami.{BuiltinNormType, FloatValue, FnValueBase, RecordType, SimpleBuiltinBinaryFn}
...
object FloatsLibrary extends NameResolutionLibrary("floats"):
  ...
  class Fn(name: String, call: (Double, Double) => Double) extends NormValue with SimpleBuiltinBinaryFn:
